...
strategy for any $m,n\ge2$. Use a symmetry strategy.
...
boat that carries at most two people. If cannibals ever outnumber
missionaries on either bank, the missionaries are eaten. Model the
...
A token starts at $(0,0)$. A move changes $(x,y)$ to $(x+2,y-1)$.
...
remaining board be tiled by dominoes? If not, prove why not using a
3-colouring. If so, give a tiling.
